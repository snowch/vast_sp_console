...
# Create CreateSchemaModal component
cat > frontend/src/components/CreateSchemaModal.js << 'EOF'
...
cat > frontend/src/services/schemaService.js << 'EOF'
